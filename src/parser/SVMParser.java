...
public class SVMParser extends Parser {
	...
	public final AssemblyContext assembly() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PRINT) | (1L << JUMPREG) | (1L << JUMPLABEL)
						| (1L << ADDINTEGER) | (1L << MOVE) | (1L << BRANCHEQ) | (1L << BRANCHGT) | (1L << BRANCHGE)
						| (1L << BRANCHLT) | (1L << BRANCHLE) | (1L << POP) | (1L << LOADWORD) | (1L << STOREWORD)
						| (1L << PUSH) | (1L << ADD) | (1L << SUB) | (1L << MUL) | (1L << DIV) | (1L << NEG)
						| (1L << LOADINTEGER) | (1L << BRANCH) | (1L << LABEL))) != 0)) {
					{
						{
							setState(4);
							instruction();
	...
	public static class InstructionContext extends ParserRuleContext {
		...
		public TerminalNode BRANCHLT() {
			return getToken(SVMParser.BRANCHLT, 0);
		}

		public TerminalNode BRANCHLE() {
	...
	public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\37>\4\2\t\2\4\3\t"
