...
public class SimplePlusParser extends Parser {
	...
	public static final int
		...
		T__4=25, T__3=26, T__2=27, T__1=28, T__0=29, BOOL=30, ID=31, NUMBER=32, 
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__27) | (1L << T__24) | (1L << T__22) | (1L << T__18) | (1L << T__16) | (1L << T__15) | (1L << T__14) | (1L << T__5) | (1L << ID))) != 0)) {
				{
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						consume();
						setState(151); ((BinExpContext)_localctx).right = exp(11);
						}
						break;
					case 2:
						{
						...
						consume();
						setState(154); ((BinExpContext)_localctx).right = exp(10);
						}
						break;
					case 3:
						{
						...
						((BinExpContext)_localctx).op = _input.LT(1);
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__17) | (1L << T__9) | (1L << T__7) | (1L << T__6))) != 0)) ) {
							((BinExpContext)_localctx).op = (Token)_errHandler.recoverInline(this);
						}
						consume();
						setState(157); ((BinExpContext)_localctx).right = exp(9);
						}
						break;
					case 4:
						{
						...
						consume();
						setState(160); ((BinExpContext)_localctx).right = exp(8);
						}
						break;
					case 5:
						{
						...
						setState(162); ((BinExpContext)_localctx).op = match(T__21);
						setState(163); ((BinExpContext)_localctx).right = exp(7);
						}
						break;
					case 6:
						{
						...
						setState(165); ((BinExpContext)_localctx).op = match(T__25);
						setState(166); ((BinExpContext)_localctx).right = exp(6);
						}
						break;
					}
					} 
